...
WebUI.scrollToElement(findTestObject('Page_Upload Data SIMON - SIMON/li_select2-Segmen-result-lgyc-4'), 10)

WebUI.mouseOver(findTestObject('Page_Upload Data SIMON - SIMON/li_select2-Segmen-result-lgyc-4'))

WebUI.click(findTestObject('Page_Upload Data SIMON - SIMON/li_select2-Segmen-result-lgyc-4'))
