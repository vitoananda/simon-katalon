...
WebUI.scrollToElement(findTestObject('Page_Upload Data SIMON - SIMON/li_select2-Segmen-result-7kh1-3'), 10)

WebUI.mouseOver(findTestObject('Page_Upload Data SIMON - SIMON/li_select2-Segmen-result-7kh1-3'))

WebUI.click(findTestObject('Page_Upload Data SIMON - SIMON/li_select2-Segmen-result-7kh1-3'))
